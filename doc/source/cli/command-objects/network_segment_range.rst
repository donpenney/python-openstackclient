...
.. option:: --used
    ...
    List network segment ranges that have segments not in use currently

.. option:: --unused

    List network segment ranges that do not have segments not in use currently

.. option:: --available

    List network segment ranges that have available segments currently
